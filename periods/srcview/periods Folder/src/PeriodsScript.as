public const ENDPOINT_URL:String = "php/Periods.php";
...
[Bindable]public var popChoices:ArrayCollection = new ArrayCollection();
private var orderColumn:Number;
private var fields:Object = { 'Id':Number, 'ListOrder':Number, 'Visible':String, 'Period':String, 'Code':String, 'SubPeriod':String};
...
public function goToUpdate():void
{
	...
	public var thePopVal:String;
   	private function fillPop():void{
   	popChoices.addItem({label:"List All"});
   	popChoices.addItem({label:"Visible"});
   	popChoices.addItem({label:"Hidden"});
   }      
      
        
   private function closeHandler(event:Event):void {
     thePopVal = ComboBox(event.target).selectedItem.label;
     fill();
            }    
...
private function editCellEnd(e:DataGridEvent):void
{
    ...
    var parameters:* =
    {
        "Id": vo.IdCol,        "ListOrder": vo.ListOrderCol,        "Visible": vo.VisibleCol,        "Period": vo.PeriodCol,        "Code": vo.CodeCol,        "SubPeriod": vo.SubPeriodCol    }
...
private function insertItem():void {
    var parameters:* =
    {
        "method": "Insert",		"ListOrder": ListOrderCol.text,		"Visible": VisibleCol.text,		"Period": PeriodCol.text,		"Code": CodeCol.text,		"SubPeriod": SubPeriodCol.text    };
