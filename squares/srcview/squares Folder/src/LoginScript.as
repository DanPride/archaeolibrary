...
[Bindable]protected var digCode:String;
[Bindable]protected var squareMinLength:Number;
[Bindable]protected var squareMaxLength:Number;
[Bindable]protected var squareIsNumber:Number;
[Bindable]protected var squareMinValue:Number;
[Bindable]protected var squareMaxValue:Number;
...
private function logInHandler(e:Object):void
{
	if (e.isError){Alert.show("Error: " + e.data.error);
		...
		loginUser = e.data[0].row.User.toString();
		digName = e.data[0].row.DigName.toString();
		digCode = e.data[0].row.DigCode.toString();
		squareIsNumber = e.data[0].row.SquareIsNumber.toString();
		squareMinLength = e.data[0].row.SquareMinLength.toString();
		squareMaxLength = e.data[0].row.SquareMaxLength.toString();
		squareMinValue = e.data[0].row.SquareMinValue.toString();
		squareMaxValue = e.data[0].row.SquareMaxValue.toString();
