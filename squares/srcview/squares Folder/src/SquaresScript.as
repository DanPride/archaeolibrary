...
public const ENDPOINT_URL:String = "php/Squares.php";
...
private var fields:Object = { 'Id':Number, 'Name':String, 'Field':String, 'Square':String, 'Open':String,'Supervisor':String};
private var fieldsFields:Object = { 'Id':Number, 'Name':String, 'Code':String,'Field':String, 'Supervisor':String, 'Open':String };
...
private function entryVal():Boolean
{
	var inValidArray:Array = 
		Validator.validateAll([confirmSquareVal]);
...
private function editCellEnd(e:DataGridEvent):void
{
    ...
    var parameters:* =
    {
        "Id": vo.IdCol,        "Name": vo.NameCol,        "Field": vo.FieldCol,        "Square": vo.SquareCol,        "Open": vo.OpenCol   ,        "Supervisor": vo.SupervisorCol }
...
private function insertItem():void {
    var parameters:* =
    {
        "method": "Insert",	"Field": FieldCombo.selectedLabel, "Square": SquareInput.text,	"Open": OpenCol.selectedLabel, "Supervisor": SupervisorCol.text  };
