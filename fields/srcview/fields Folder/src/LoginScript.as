...
[Bindable]protected var fieldMinLength:Number;
[Bindable]protected var fieldMaxLength:Number;
[Bindable]protected var fieldIsNumber:Number;
[Bindable]protected var fieldMinValue:Number;
[Bindable]protected var fieldMaxValue:Number;
...
private function logInHandler(e:Object):void
{
	if (e.isError){Alert.show("Error: " + e.data.error);
		...
		if(loginStatus != "Success"){
			...
			fieldIsNumber = e.data[0].row.FieldIsNumber.toString();
			fieldMinLength = e.data[0].row.FieldMinLength.toString();
			fieldMaxLength = e.data[0].row.FieldMaxLength.toString();
			fieldMinValue = e.data[0].row.FieldMinValue.toString();
			fieldMaxValue = e.data[0].row.FieldMaxValue.toString();
