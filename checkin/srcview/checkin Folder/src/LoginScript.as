...
[Bindable]protected var bucketMinLength:Number;
[Bindable]protected var bucketMaxLength:Number;
[Bindable]protected var bucketMinValue:Number;
[Bindable]protected var bucketMaxValue:Number;

[Bindable]protected var locusMinLength:Number;
[Bindable]protected var locusMaxLength:Number;
[Bindable]protected var locusMinValue:Number;
[Bindable]protected var locusMaxValue:Number;
...
private function logInHandler(e:Object):void
{
	if (e.isError){Alert.show("Error: " + e.data.error);
		...
		if(loginStatus != "Success"){
			...
			bucketMinLength = e.data[0].row.BucketMinLength.toString();
			bucketMaxLength = e.data[0].row.BucketMaxLength.toString();
			bucketMinValue = e.data[0].row.BucketMinValue.toString();
			bucketMaxValue = e.data[0].row.BucketMaxValue.toString();
			locusMinLength = e.data[0].row.LocusMinLength.toString();
			locusMaxLength = e.data[0].row.LocusMaxLength.toString();
			locusMinValue = e.data[0].row.LocusMinValue.toString();
			locusMaxValue = e.data[0].row.LocusMaxValue.toString();
