...
function findPhotos() {
		...
		//if(@$_REQUEST['photoDefPop']=="Formal"){@$_REQUEST['photoDefPop']="Original";}
		//if(@$_REQUEST['photoDefPop']=="Library"){@$_REQUEST['photoDefPop']="Formal";}
		if(@$_REQUEST['photoDefPop']=="Library"){@$_REQUEST['photoDefPop']="Original";}
