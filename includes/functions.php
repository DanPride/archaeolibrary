...
function yearPop(){
	...
	$YearPop .= "<option" . $Select18 . ">2018</option>";
	$YearPop .= "<option" . $Select17 . ">2017</option>";
	$YearPop .= "<option" . $Select16 . ">2016</option>";
	$YearPop .= "<option" . $Select15 . ">2015</option>";
	$YearPop .= "<option" . $Select14 . ">2014</option>";
	$YearPop .= "<option" . $Select13 . ">2013</option>";
	$YearPop .= "<option" . $Select12 . ">2012</option>";
...
function userPop($headerInsert = ""){
	...
	if($headerInsert == $_SESSION['Name']){
		$userPop .= "<option" . " selected=\"selected\"" . ">" . $headerInsert . "</option>";
	} else {
...
function userusePop($headerInsert = ""){
	...
	if($headerInsert == $_SESSION['User']){
		$userusePop .= "<option" . " selected=\"selected\"" . ">" . $headerInsert . "</option>";
	} else {
...
function pagePop($headerInsert = ""){
	...
	if($headerInsert == $_SESSION['Page']){
		$pagePop .= "<option" . " selected=\"selected\"" . ">" . $headerInsert . "</option>";
	} else {
		$pagePop .= "<option>" . $headerInsert . "</option>" ;
	}
	while ($row = mysql_fetch_array($result)) {
		if($row['Name'] == $_SESSION['Page']){
