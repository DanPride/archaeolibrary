...
define("DB_PASS", "Solomon3!"); //Enter the Database Password Here
...
define("LOCUS_MINVALUE", 01000); //Enter the Minimum Number a Locus can be if it is a number only otherwise blank
...
define("BUCKET_MINVALUE", 00001); //Enter the Minimum Number a Bucket can be if it is a number only otherwise blank
define("BUCKET_MAXVALUE", 99000); //Enter the Maximum Number a Bucket can be if it is a number only otherwise blank
